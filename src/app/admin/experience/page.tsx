...
export default function ExperiencePage() {
  ...
  const handleOpenModal = (item?: Experience) => {
    if (item) {
      ...
      setEditingItem(null);
      setFormData({ company: "", position: "", location: "", startDate: "", endDate: "", description: "", visible: true, order: 0 });
    }
    setIsModalOpen(true);
  };
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-slate-900">Experience Management</h1>
      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <form id="experience-form" onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-4">
