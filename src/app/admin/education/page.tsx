...
export default function EducationPage() {
  ...
  const handleOpenModal = (item?: Education) => {
    if (item) {
      ...
      setEditingItem(null);
      setFormData({ school: "", degree: "", field: "", location: "", startDate: "", endDate: "", description: "", visible: true, order: 0 });
    }
    setIsModalOpen(true);
  };
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-slate-900">Education Management</h1>
      </div>
