...
const projects: Project[] = [
  {
    title: "SpecDeaf",
    description:
      "Built a wearable speech-to-text system for hearing-impaired individuals. Implemented real-time transcription using AI-based speech recognition and designed hardware-software integration for wearable display systems.",
    achievement: "1st Place – HealthTech Entrepreneurship, World Robotics Olympiad",
    tags: ["AI", "Accessibility", "Wearable Tech", "Speech-to-Text", "Hardware Integration"],
  },
  {
    title: "Pmesh",
    description:
      "Developed Pmesh, an early leak detection system that uses acoustic sensing and intelligent analysis to detect industrial leaks at an early stage and improve safety and operational efficiency.",
    achievement: "2x 1st Place – Teknofest",
    tags: ["Industrial Safety", "Acoustic Sensing", "Intelligent Monitoring", "MVP", "Embedded Systems"],
  },
];
